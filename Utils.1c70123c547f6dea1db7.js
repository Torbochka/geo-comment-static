...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Utils, null, [{
    ...
    value: function formatDate(date) {
      var m = date.getMonth().length > 1 ? date.getMonth() : "0".concat(date.getMonth());
      var d = date.getDay().length > 1 ? date.getDay() : "0".concat(date.getDay());
      return ["".concat(date.getFullYear(), ".").concat(m, ".").concat(d), "".concat(date.getHours(), ":").concat(m, ":").concat(date.getSeconds())].join(' ');
    }
  }, {
    key: "getCoords",
...
/******/ });
//# sourceMappingURL=Utils.1c70123c547f6dea1db7.js.map